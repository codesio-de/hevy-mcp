...
export function getBodyMeasurements(apiKey: string, params?: PaginationParams) {
  return get(apiKey, "/body_measurements", params as Record<string, number>);
}

export function getBodyMeasurement(apiKey: string, date: string) {
  return get(apiKey, `/body_measurements/${date}`);
}

export function createBodyMeasurement(apiKey: string, body: unknown) {
  return post(apiKey, "/body_measurements", body);
}

export function updateBodyMeasurement(apiKey: string, date: string, body: unknown) {
  return put(apiKey, `/body_measurements/${date}`, body);
}
